...
def home(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'django_app/pages/todo_home.html', context)
...
def create(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'django_app/pages/todo_create.html', context)
...
def read(request: HttpRequest, pk=0) -> HttpResponse:
    ...
    return render(request, 'django_app/pages/todo_detail.html', context)
...
def read_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'django_app/pages/todo_list.html', context)
...
def update(request: HttpRequest, pk=0) -> HttpResponse:
    ...
    return render(request, 'django_app/pages/todo_change.html', context)
